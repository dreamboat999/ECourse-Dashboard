<template>
  <div class="flex flex-col bg-gradient-to-b from-navigationGray to-navigationPurple">
    ...
    <div class="flex flex-col justify-between h-full px-2 xl:px-8">
      ...
      <div class="baseInactive">
        <router-link v-for="(item,index) in items" :key="index" :to="{name:item.name}" exact class="flex items-center justify-center xl:justify-start mb-4 font-medium py-1 px-2 xl:py-3 xl:px-6" active-class="text-black bg-white rounded-md">
